    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Cliente'), ('partner', 'Lojista Parceiro'), ('admin', 'Administrador')], default='customer', max_length=10, verbose_name='Tipo de Usuário')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fitness_goal', models.CharField(blank=True, max_length=50, null=True, verbose_name='Objetivo Fitness')),
                ('company_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nome da Empresa')),
                ('cnpj', models.CharField(blank=True, max_length=18, null=True, verbose_name='CNPJ')),
                ('store_address', models.TextField(blank=True, null=True, verbose_name='Endereço da Loja')),
